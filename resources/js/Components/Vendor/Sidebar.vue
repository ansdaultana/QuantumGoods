    ...
    <div class="h-auto  w-fit md:w-1/6   bg-white text-xs md:text-md  ">
        ...
        <div>
            <MenuItemSidebar @mouseenter="ProductMenu = true" @mouseleave="ProductMenu = false" @click.prevent="gotoVendorProducts">
                ...
                <span class="w-14 hidden md:block">Products</span>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-6 h-5 ml-8  hidden md:block ">
            ...
            <MenuItemSidebar>
                ...
                <span class="w-14  hidden md:block">Orders</span>
            </MenuItemSidebar>
            <MenuItemSidebar>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="w-6 h-6">
                ...
                <span class="w-14 hidden md:block">Customers</span>
            </MenuItemSidebar>
